...
import RegForm from '@/src/components/company/companyForm';
...
export default function CompanyForm() {
  ...
  const initWallet = async () => {
    ...
    if (userLicenses.length > 0) {
      const companyLicensePDA = getCompanyLicensePDA(program, userLicenses[userLicenses.length-1].account.name);
